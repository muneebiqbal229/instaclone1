...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://pr1-ctabe6djgpardecr.ukwest-01.azurewebsites.net/api/v1/post/${post._id}/${action}`, { withCredentials: true });
            if (res.data.success) {
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`https://pr1-ctabe6djgpardecr.ukwest-01.azurewebsites.net/api/v1/post/${post._id}/comment`, { text }, {
                headers: {
    ...
    const deletePostHandler = async () => {
        try {
            const res = await axios.delete(`https://pr1-ctabe6djgpardecr.ukwest-01.azurewebsites.net/api/v1/post/delete/${post?._id}`, { withCredentials: true });
            if (res.data.success) {
    ...
    const bookmarkHandler = async () => {
        try {
            const res = await axios.get(`https://pr1-ctabe6djgpardecr.ukwest-01.azurewebsites.net/api/v1/post/${post?._id}/bookmark`, {withCredentials:true});
            if(res.data.success){
                toast.success(res.data.message);
            }
        } catch (error) {
